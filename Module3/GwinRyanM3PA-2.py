...
Assignment: Module3 Programming Assignment Part 2

Instructions: 
Write a program that writes a series of random numbers to a file and displays all the numbers to the console. 
Each random number should be in the range of 1 through 500. 
The application should let the user specify how many random numbers the file will hold. (15 points)
